...
impl<W: Write> ToNetworkOrder<W> for Ipv4Addr {
    /// Example:    
    /// ```
    /// use std::str::FromStr;
...
impl<'a, R: Read> FromNetworkOrder<'a, R> for Ipv4Addr {
    /// Example:    
    /// ```
    /// use std::io::Cursor;
...
impl<W: Write> ToNetworkOrder<W> for Ipv6Addr {
    /// Example:    
    /// ```
    /// use std::str::FromStr;
    /// use type2network::ToNetworkOrder;
...
impl<'a, R: Read> FromNetworkOrder<'a, R> for Ipv6Addr {
    /// Example:    
    /// ```
    /// use std::io::Cursor;
    /// use type2network::FromNetworkOrder;
