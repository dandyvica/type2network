...
use quote::ToTokens;
use syn::{
    parse_quote, Attribute, DeriveInput, Expr, Fields, FieldsNamed, FieldsUnnamed, GenericParam,
    Generics, Ident, Lifetime, LifetimeParam, TypeParam, Variant,
};
...
pub(super) fn process_generics(ast: &DeriveInput) -> Generics {
